INSERT INTO tbl_categories (id, name) VALUES (1, 'zapatos');
INSERT INTO tbl_categories (id, name) VALUES (2, 'libros');
INSERT INTO tbl_categories (id, name) VALUES (3, 'electronicos');

--INSERT INTO tbl_products (name, description, stock,price,status, create_at,category_id)
--VALUES ('adódas Cloudfoam Ultimate','Walk in the air in the black / black CLOUDFOAM ULTIMATE running shoe from ADIDAS',5,178.89,'CREATED','2018-09-05',1);
