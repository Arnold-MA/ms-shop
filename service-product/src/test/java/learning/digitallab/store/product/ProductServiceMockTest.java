...
import learning.digitallab.store.product.service.ProductService;
import learning.digitallab.store.product.service.ProductServiceImpl;
...
public class ProductServiceMockTest {
    ...
    @BeforeEach
    public void setup() {
        final var mockito = MockitoAnnotations.openMocks(this);
